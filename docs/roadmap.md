...
- [x] **Tenancy depth** — approvals are scoped by tenant (list, decide and
      verify), keyed on the caller's identity; a manager sees only their own
      tenant's queue (`docs/tenancy.md`)
